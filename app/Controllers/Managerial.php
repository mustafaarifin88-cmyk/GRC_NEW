...
class Managerial extends BaseController
{
    ...
    public function reportList()
    {
        ...
        if (!empty($id_bawahans)) {
            $data['reports'] = $reportModel->whereIn('id_user_staff', $id_bawahans)
                                           ->where('posisi_approval', 'MANAGERIAL')
    ...
    public function approveReport()
    {
        ...
        $reportModel->update($id, [
            'posisi_approval' => 'PIMPINAN TINGGI',
            'status_approval' => 'PROSES'
        ]);

        return redirect()->to('/managerial/reports')->with('success', 'Laporan berhasil di-approve dan diteruskan ke Pimpinan Tinggi');
    }
    ...
    public function rejectReport()
    {
        ...
        $notifModel->insert([
            ...
            'judul'   => 'Laporan Ditolak oleh Managerial',
            'pesan'   => 'Laporan Anda ditolak. Alasan: ' . $alasan,
            'link'    => '/report/tracking'
        ]);

        return redirect()->to('/managerial/reports')->with('success', 'Laporan berhasil ditolak');
    }
