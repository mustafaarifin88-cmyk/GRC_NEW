...
<div>
<h2 class="text-2xl font-bold">Form Incident Bond (GRC)</h2>
<p class="text-red-100 text-sm mt-1">Pelaporan insiden operasional, risiko kritis, atau kecelakaan kerja.</p>
</div>
</div>
<div class="p-6 sm:p-8">
<form action="<?= base_url('staff/internal-audit-grc/incident-bond/save') ?>" method="post" enctype="multipart/form-data" class="space-y-6">
<div>
<label class="block text-sm font-semibold text-slate-700 mb-2">Judul Laporan Insiden <span class="text-red-500">*</span></label>
<input type="text" name="title" required placeholder="Contoh: Insiden Kegagalan Sistem Transaksi Core Banking" class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:ring-2 focus:ring-red-500 focus:border-red-500 outline-none transition bg-slate-50 focus:bg-white">
</div>
<div>
<label class="block text-sm font-semibold text-slate-700 mb-2">Kronologi & Dampak Insiden <span class="text-red-500">*</span></label>
<textarea name="description" rows="5" required placeholder="Jelaskan waktu, tempat, pihak terkait, dan deskripsi lengkap kejadian..." class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:ring-2 focus:ring-red-500 focus:border-red-500 outline-none transition bg-slate-50 focus:bg-white"></textarea>
</div>
<div>
