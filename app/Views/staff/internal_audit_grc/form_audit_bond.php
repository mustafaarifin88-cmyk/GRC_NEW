...
<div>
<h2 class="text-2xl font-bold">Form Audit Bond (GRC)</h2>
<p class="text-blue-100 text-sm mt-1">Lengkapi data laporan temuan audit internal secara komprehensif.</p>
</div>
</div>
<div class="p-6 sm:p-8">
<form action="<?= base_url('staff/internal-audit-grc/audit-bond/save') ?>" method="post" enctype="multipart/form-data" class="space-y-6">
<div>
<label class="block text-sm font-semibold text-slate-700 mb-2">Judul Laporan Audit <span class="text-red-500">*</span></label>
<input type="text" name="title" required placeholder="Contoh: Laporan Audit Operasional Q3" class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition bg-slate-50 focus:bg-white">
</div>
<div>
<label class="block text-sm font-semibold text-slate-700 mb-2">Deskripsi Temuan Audit <span class="text-red-500">*</span></label>
<textarea name="description" rows="5" required placeholder="Jelaskan detail temuan audit dan rekomendasi..." class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition bg-slate-50 focus:bg-white"></textarea>
</div>
<div>
<label class="block text-sm font-semibold text-slate-700 mb-2">Upload Eviden Audit <span class="text-red-500">*</span></label>
...
<i class="bi bi-send-fill mr-2"></i> Submit Audit
</button>
</div>
</form>
</div>
